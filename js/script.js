const global = {
    ...
    api: {
      apiKey: '6b9ee9850ed777e8954994eb19c8d740',
...
// ANCHOR Display Search Results Function
...
async function displaySlider() {
  ...
  console.log('results received here');
  results.forEach((movie) => {
    const div = document.createElement('div');
...
function highlightActiveLink(page) {
    const linkSelected = document.querySelectorAll('.nav-link');

    linkSelected.forEach((link) => {
